            ...
            <div class="product-slider owl-carousel owl-theme">
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail"><img src="{{ url ('public') }} /img/product1.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail"><img src="{{ url ('public') }} /img/product1_2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail" class="invisible"><img src="{{ url ('public') }} /img/product1.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail"><img src="{{ url ('public') }} /img/product3.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail"><img src="{{ url ('public') }} /img/product3_2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail" class="invisible"><img src="{{ url ('public') }} /img/product3.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
              ...
              <div class="item">
                <div class="product">
                  ...
                  </div><a href="detail" class="invisible"><img src="{{ url ('public') }} /img/product2.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
                    <h3><a href="detail">White Blouse Armani</a></h3>
                    <p class="price"> 
                      <del>Rp.280.000</del>Rp.143.000
                    </p>
                  </div>
                  <!-- /.text-->
                  <div class="ribbon sale">
              ...
              <div class="item">
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      <div class="front"><a href="detail.html"><img src="{{ url ('public') }} /img/product3.jpg" alt="" class="img-fluid"></a></div>
                      <div class="back"><a href="detail.html"><img src="{{ url ('public') }} /img/product3_2.jpg" alt="" class="img-fluid"></a></div>
                    </div>
                  </div><a href="detail.html" class="invisible"><img src="{{ url ('public') }} /img/product3.jpg" alt="" class="img-fluid"></a>
                  <div class="text">
